...
<head>
    ...
    <title>Inova Tech :: Instruções Enviadas</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            ...
            <div class="container text-warning">
                ...
                <p>
                    Cordialmente,<br> Central de Relacionamento Inova Tech
                </p>
                <p>
                    <a href="index.php" class="btn btn-lg btn-dark text-bg-warning">Voltar à Página Principal</a>
                </p>
