...
<head>
    ...
    <title>Inova Tech :: Contato</title>
</head>
            ...
            <div class="container">
                <div class="row justify-content-center text-warning">
                    <form class="col-sm-10 col-md-8 col-lg-6">
                        ...
                        <button type="button" onclick="window.location.href='confirmcontato.php'" class="btn btn-lg btn-dark text-bg-warning">Enviar Mensagem</button>
                        ...
                        <p class="mt-3">
                            Atenciosamente,<br> Central de Relacionamento Inova Tech
                        </p>
                    </form>
                </div>
            </div>
