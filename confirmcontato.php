...
<head>
    ...
    <title>Inova Tech:: Mensagem Recebida</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container text-warning">
                ...
                <p>
                    Cordialmente,<br> Central de Relacionamento Loja de jogos
                </p>
            </div>
        </main>
            ...
            <div class="container ">
                <div class="row py-3 ">
                    ...
                    <div class="col-12 col-md-4 text-center ">
                        <a href="privacidade.php " class="text-decoration-none text-warning">Política de Privacidade</a><br>
                        <a href="termos.php " class="text-decoration-none text-warning ">Termos de Uso</a><br>
                        <a href="quemsomos.php " class="text-decoration-none text-warning">Quem Somos</a><br>
                        <a href="cancelamento.php " class="text-decoration-none text-warning ">Política de Cancelamento</a>
                        <br>
                    </div>
                    <div class="col-12 col-md-4 text-center">
